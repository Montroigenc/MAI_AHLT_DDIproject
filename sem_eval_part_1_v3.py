...
# x_train_vec = np.asarray(x_train_vec_aux).tolist()
...
clf_perceptron = Perceptron(verbose=0, n_jobs=-1, max_iter=5)
...
# names = ["Perceptron", "Decision tree", "Naive Bayes", "Multi Layer Perceptron"]
# clfs = [clf_perceptron, clf_tree, clf_NB, clf_MLP]

names = ["Conditional random fields", "Perceptron", "Decision tree", "Naive Bayes", "Multi Layer Perceptron"]
clfs = [clf_CRF, clf_perceptron, clf_tree, clf_NB, clf_MLP]
...
for name, clf in zip(names, clfs):
    ...
    #     chunker = ScikitLearnChunker.train(x_train, y_train, features, clf, vectorizer)
